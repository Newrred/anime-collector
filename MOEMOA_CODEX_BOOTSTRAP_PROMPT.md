...
> **문서 상태: `REFERENCE_MIRROR / COMPLETED`**
> canonical prompt는 `prompts/moemoa/01_BOOTSTRAP_REPOSITORY_AUDIT.md`다. 이 저장소의 최초 감사는 2026-08-11 완료되었으므로 코드·인프라가 크게 바뀌어 재감사가 필요할 때만 사용한다. 내용 변경은 canonical prompt에 먼저 반영한다.
