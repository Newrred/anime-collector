...
| `04_PRIVATE_VERTICAL_SLICE.md` | `GATED` | `TECH-01`, `STORAGE-LOCAL-01`, `LEGACY-01`과 slice ExecPlan 승인 뒤 |
...
`TECH-01`, `STORAGE-LOCAL-01`, `LEGACY-01`과 prompt 02 산출물은 승인됐다. prompt 04를 한 번에 실행하지 않고 `docs/moemoa/plans/first-private-vertical-slice.md`의 Milestone 0부터 진행한다. 현재 Node 22+와 Android Studio 2025.2.1+ environment gate가 남아 있다.
