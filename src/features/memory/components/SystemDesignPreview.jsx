...
export default function SystemDesignPreview({ spec, title, className = "" }) {
  ...
  return (
    ...
    >
      <span className="system-design-preview__label">System design preview</span>
      <strong>{title || "Your memory"}</strong>
      <small>MOEMOA · Private memory</small>
    </div>
  );
}
